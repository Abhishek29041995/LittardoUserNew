    ...
    return Scaffold(
      ...
      body: (wishListData.length > 0 && serviceCalled)
          ...
          : (wishListData.length == 0 && serviceCalled)
              ? Center(
                  child: Image.asset("norecordfound.png"),
                )
              : SizedBox(),
    );
  }
        ...
        Navigator.of(context).push(new MaterialPageRoute(
            builder: (context) => new ProductPage(
                  product: Product(
                      ...
                      icon: wishListData[index]["thumbnail_img"],
                      rating: double.parse(wishListData[index]["rating"]),
                      remainingQuantity: 5,
                      price: '\u20b9 ${wishListData[index]["purchase_price"]}',
                      isWishlisted: wishListData[index]['wishlisted_count'],
